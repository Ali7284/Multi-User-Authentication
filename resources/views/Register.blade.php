            ...
            <div class="container bg-dark">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6 col-xxl-5">
                        <div class="card border border-light-subtle bg-dark rounded-4">
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                <form action="{{route('account.process-register')}}" method="post">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control @error('confirm_password') is-invalid @enderror" name="password_confirmation" id="confirm_password" value="" placeholder="Confirm Password" >
